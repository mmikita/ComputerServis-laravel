...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background mbr-after-navbar" id="header1-73" style='background-image: url(assets/images/computer.jpg'>
 ...
 <section class="content-2" id="features1-75" style="background-color: rgb(239, 239, 239);">
...
<section class="mbr-section mbr-section--relative mbr-parallax-background" id="msg-box5-79" style="background-image: url(assets/images/iphone-6-458150-1920-1920x1285-73.jpg);">
                ...
                <div class="mbr-box__magnet mbr-class-mbr-box__magnet--center-left col-sm-6 mbr-section__right">
                    <div class="mbr-section__container mbr-section__container--middle">
                        <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
                            <h3 class="mbr-header__text">O naszym serwisie</h3>
                    ...
                    <div class="mbr-section__container">
                        <div class="mbr-buttons mbr-buttons--auto-align btn-inverse"><a class="mbr-buttons__btn btn btn-lg btn-default" href="#">Napisz do nas!</a></div>
                    </div>
                </div>
 ...
 <section class="content-2" id="costs" style="background-color: rgb(239, 239, 239);">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="testimonials1-88"  style="background-color: rgb(239, 239, 239);">
...
ul. Powichowska 22a<br>
22-234 Warszawa<br><br>
<strong>Kontakt:</strong><br>
Email: pomoc@pcstart.com<br>
Phone: + 48 000 000 000<br>
</p>
                    </div>
                </div>
            </div>
